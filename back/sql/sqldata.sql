...
VALUES
    ('dog1', 'male', 'adult', 'spayed', '50kg', 'mixed', now() - INTERVAL 10 DAY, 'text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretexttext sometext moretexttext sometext moretext text sometext moretext text sometext moretext text sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext', 'https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/41628664/1/', 1),
    ('dog2', 'female', 'puppy', 'not spayed', '81kg', 'Kuvasz', now() - INTERVAL 11 DAY, 'text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretexttext sometext moretexttext sometext moretext text sometext moretext text sometext moretext text sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext', 'https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/41610832/1/', 1),
    ...
    ('dog5', 'female', 'adult', 'not spayed', '34kg', 'mixed', now() - INTERVAL 54 DAY, 'text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretexttext sometext moretexttext sometext moretext text sometext moretext text sometext moretext text sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretexttext sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretexttext sometext moretexttext sometext moretext text sometext moretext text sometext moretext text sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext', 'https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/41560775/1/', 1),
    ...
    ('dog7', 'female', 15, 'not spayed', '32kg', 'mixed', now() - INTERVAL 61 DAY, 'text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretexttext sometext moretexttext sometext moretext text sometext moretext text sometext moretext text sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext ', 'https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/41552689/1/', 1),
    ...
    ('dog9', 'male', 'puppy', 'not spayed', '1kg', 'husky', now() - INTERVAL 54 DAY, 'text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretexttext sometext moretexttext sometext moretext text sometext moretext text sometext moretext text sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext ', 'https://puranaturalspet.com/blog/wp-content/uploads/2017/09/Home-Dog.jpg', 1),
    ('dog10', 'female', 'adult', 'not spayed', '21kg', 'corgi', now() - INTERVAL 43 DAY, 'text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretexttext sometext moretexttext sometext moretext text sometext moretext text sometext moretext text sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext ', 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Welchcorgipembroke.JPG/1200px-Welchcorgipembroke.JPG', 1),
    ...
    ('dog13', 'female', 'adult', 'not spayed', '24kg', 'mixed', now() - INTERVAL 13 DAY, 'text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretext text sometext moretexttext sometext moretexttext sometext moretext text sometext moretext text sometext moretext text sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext moretexttext sometext ', 'http://trupanion.com/blog/wp-content/uploads/2017/09/GettyImages-512536165.jpg', 1),
