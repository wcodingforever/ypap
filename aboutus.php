...
<body>
    ...
    <div id="everythingwrapper">
        ...
        <div id="text">
            ...
            <h3>The Yongin Animal Protection Association has given these animals a second chance. Now we, the international rescue community, are joining them to help find families for the unwanted and abandoned dogs of Korea.</h3>
            *YPAP is not a rescue group and is not a registered non-profit organization. We are simply a group of volunteers promoting the adoption of dogs in need.
        </div>
    </div>
</body>
</html>